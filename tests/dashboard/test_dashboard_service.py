...
class TestDashboardService:
    ...
    def test_get_summary_with_data(self, app):
        ...
        MeasurementService(db).create("esp32-dash", bus_voltage=5.0, shunt_voltage=80.0, current=200, power=1000)
    ...
    def test_get_statistics_with_data(self, app):
        ...
        MeasurementService(db).create("esp32-dash-stats", bus_voltage=5.0, shunt_voltage=80.0, current=200, power=1000)
    ...
    def test_get_statistics_with_device_filter(self, app):
        ...
        MeasurementService(db).create("esp32-filter-dev", bus_voltage=5.0, shunt_voltage=80.0, current=200, power=1000)
    ...
    def test_get_statistics_with_session_filter(self, app):
        ...
        MeasurementService(db).create("esp32-filter-sess", bus_voltage=5.0, shunt_voltage=80.0, current=200, power=1000)
    ...
    def test_get_statistics_with_date_filter(self, app):
        ...
        MeasurementService(db).create("esp32-filter-date", bus_voltage=5.0, shunt_voltage=80.0, current=200, power=1000)
    ...
    def test_get_statistics_outside_date_range(self, app):
        ...
        MeasurementService(db).create(
            "esp32-filter-date2", bus_voltage=5.0, shunt_voltage=80.0, current=200, power=1000
        )
    ...
    def test_get_energy_breakdown_with_device_filter(self, app):
        ...
        MeasurementService(db).create(
            "esp32-energy-filter", bus_voltage=5.0, shunt_voltage=80.0, current=200, power=1000
        )
