class TestMeasurementsAPI:
    ...
    def test_post_measurement_missing_fields(self, client, device_auth_header):
        resp = client.post("/api/v1/measurements", json={"device_id": "esp32-auth"}, headers=device_auth_header)
