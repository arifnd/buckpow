class TestAlertsAPI:
    ...
    def test_list_alerts_filter_level(self, client, sample_device_id):
        client.post("/api/v1/alerts", json={"device_id": sample_device_id, "message": "W", "level": "warning"})
        client.post("/api/v1/alerts", json={"device_id": sample_device_id, "message": "I", "level": "info"})
    ...
    def test_list_alerts_filter_resolved(self, client, sample_device_id):
        created = client.post("/api/v1/alerts", json={"device_id": sample_device_id, "message": "Resolve me"}).json()
    ...
    def test_resolve_alert(self, client, sample_device_id):
        created = client.post("/api/v1/alerts", json={"device_id": sample_device_id, "message": "To resolve"}).json()
